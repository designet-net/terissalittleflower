...
class ThemePageController
{
    ...
    public static function ThemePageSubMenu()
    {
        ...
        add_submenu_page('themes.php', __('Theme Settings', 'idea-flow'), __('Theme Settings', 'idea-flow') . $awaiting, 'manage_options', self::GetPageSlug(), array(__CLASS__, 'ThemePageContent'), 1);
    }
