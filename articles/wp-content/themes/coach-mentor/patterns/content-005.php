...
<p class="has-text-align-center has-mono-2-color has-text-color has-superbfont-small-font-size">Our physical presence mirrors our commitment to being a beacon of creativity and expertise.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:image {"align":"center","id":2025,"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image aligncenter size-large"><img src="<?php echo esc_url(get_stylesheet_directory_uri() . "/assets/images/content/content-5.png");?>" alt="" class="wp-image-2025"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->